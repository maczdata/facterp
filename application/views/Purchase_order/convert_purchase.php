...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Order Convert Into Purchase</h2>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-prepend input-group">
                                                        ...
                                                        $date = explode(" ", $ordr[0]->date_created);
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="account" id="account" class="chosen-select">
                                                        ...
                                                        <?php foreach ($accounts as $account) { ?>
                                                            <option <?= $ordr[0]->account_id == $account->account_id ? "selected" : "" ?> value="<?= $account->account_id ?>"><?= $account->account_name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
...
//                                                        print_r($inv_item->qty);
                                                        $html .= '<div class="col-sm-12 prod" id="prod' . $id . '"><div class="col-sm-4">';
...
//                echo $key . "<br>";
                                                        ...
                                                        $html .= '<div class="col-sm-2"><div id="div_purchase_price' . $id . '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" onkeyup="CalculateSubTotal(' . $id . ');" step="0.01" name="purchase_price[]" id="purchase_price' . $id . '" value="' . $inv_item->product_purchase_price . '" class="form-control" placeholder="Purchase Price"><span class="input-group-addon bootstrap-touchspin-postfix">Rs</span></div></div>';
                                                        ...
                                                        $html .= '<div class="col-sm-1" style="width:12%; display:none;"><div id="div_batch' . $id . '" class="input-group"><select onchange="GetBatchProCount(this.value,' . $id . ')" name="batch[]" id="batch' . $id . '" class="chosen-select">';
                                                        ...
                                                        $html .= '</select></div></div>';
                                                        $html .= '<div class="col-sm-1" style="width:12%;"><div class="input-group"><input type="number" readonly="" onblur="setTwoNumberDecimal(this.id)" step="0.01" name="sub_total[]" id="sub_total' . $id . '" class="form-control sub_total" value="' . $inv_item->ordr_subtotal . '" placeholder="Sub Total"></div></div>';
...
//                                                document.getElementsByClassName("discount").addEventListener('keyup', checkTabPress);
                                                ...
                                                function add_units(u_id, unit_symbol) {
                                                    ...
                                                    $("#div_Purchase_price" + u_id).append('<span class="input-group-addon bootstrap-touchspin-postfix">Rs</span>');
                                                ...
                                                function add_product() {
                                                    ...
                                                    html += '<div class="col-sm-1" style="width:12%; display:none;"><div id="div_batch' + id + '" class="input-group"><select onchange="GetBatchProCount(this.value,' + id + ')" name="batch[]" id="batch' + id + '" class="chosen-select">' + $("#batch_suggestions").val() + '</select></div></div>';
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input onblur="setTwoNumberDecimal(this.id);" onkeyup="TotalordrAmount();" type="number" name="total_discount" id="total_discount" value="<?= $ordr[0]->total_discount ?>" class="form-control" placeholder="Total discount">
                                                </div>
                                                ...
                                                <div class="col-sm-2">
                                                    <select name="paying_by" id="paying_by" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <option <?= $ordr[0]->payment_method == 'Cash' ? "selected" : "" ?> value="Cash">Cash</option>
                                                        <option <?= $ordr[0]->payment_method == 'Bank' ? "selected" : "" ?> value="Bank">Bank</option>

                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Purchase Voucher No</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="pv_no" id="pv_no" class="form-control" readonly="" value="<?= $last_Purchase_no ?>">
                                                </div>

                                                <label class="col-sm-2 control-label">Bilty No</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="builty_no" id="builty_no" class="form-control" placeholder="Enter Bilty No" value="<?= $ordr[0]->builty_no ?>">
                                                </div>
                                            ...
                                            <div class="form-group" style="display:none;">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="cargo" id="cargo" class="form-control" placeholder="Enter Cargo No" value="<?= $ordr[0]->cargo ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="destination" id="destination" class="form-control" placeholder="Enter Destination" value="">
                                                </div>
                                            </div>
                                            <div class="form-group" style="display: none;">
                                                <label class="col-sm-2 control-label">Driver Name</label>   
                                                <div class="col-sm-2">
                                                    <input  type="text" name="driver_name" id="driver_name" class="form-control" placeholder="Enter Driver Name" value="">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button id="confrm_btn" class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>Confirm Order Convert Into Purchase</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
...
//                    alert(batch_no);
                    $.post("<?= base_url() ?>Purchase/GetBatchProCount", {batch_no: batch_no}, function (result) {
                        var res = result.split("%");
                        var total_purchase_qty = parseFloat(res[0]);
                        var max_qty = parseFloat(res[1]);
                        var curr_qty = parseFloat($("#qty" + id).val());
                        var total_curr_purchase_qty = curr_qty + total_Purchase_qty;
//                        alert(total_curr_Purchase_qty);
                        if (total_curr_purchase_qty > max_qty) {
