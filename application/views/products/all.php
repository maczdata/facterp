                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <table  class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                                                    ...
                                                    foreach ($products as $product):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                                ...
                                                                <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteProduct('<?= $product['product_id'] ?>');">
                                                                    <i class="glyph-icon icon-trash"></i>
                                                                </button>
                                                            <?php } ?>    

                                                                <button onclick="GoLedger('<?= $product['product_id'] ?>');" data-toggle="tooltip" data-placement="top" title="View"  class="btn btn-round btn-success" >
                                            ...
                                            if (isset($cate) && isset($war) && isset($pro)) {
                                                if (empty($cat)) {
                                                    $cat = NULL;
                                                }
                                                if (empty($war)) {
                                                ...
                                                echo $this->ajax_pagination->create_links(NULL, NULL, NULL, $cate, $war, $pro);
                                            } if (!isset($search) && !isset($date_from) && !isset($date_to) && !isset($cate) && !isset($war) && !isset($pro)) {
