...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>products/add" id="SubmitAdd" class="form-horizontal bordered-row">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select name="product_category" onchange="RevertValidation()" id="product_category" class="chosen-select ">
                                                        <option value="">Select Option</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select name="product_unit" onchange="RevertValidation()" id="product_unit" class="chosen-select">
                                                        ...
                                                        <?php foreach ($units as $unit) { ?>
                                                            <option value="<?= $unit->unit_id ?>"><?= $unit->unit_symbol ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <label class="col-sm-2 control-label">Purchase Unit</label>
                                                <div class="col-sm-2">
                                                    <select name="purchase_unit" onchange="RevertValidation()" id="purchase_unit" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <?php foreach ($units as $unit) { ?>
                                                            <option value="<?= $unit->unit_id ?>"><?= $unit->unit_symbol ?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="col-sm-2">
                                                    <select name="sale_unit" id="sale_unit" onchange="RevertValidation()" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <?php foreach ($units as $unit) { ?>
                                                            <option value="<?= $unit->unit_id ?>"><?= $unit->unit_symbol ?></option>
                                                        <?php } ?>
            ...
            <script>
                ...
                function ConfirmAdd() {
                    ...
                    //     $("#product_rate").css("border", "1px solid red");
                    //     err = true;
                    // }
                    ...
                    if (sale_unit == "" || sale_unit == null) {
                        $("#sale_unit_chosen").css("border", "1px solid red");
                        err = true;
                    }
                ...
                function RevertValidation() {
                    ...
                    if (product_type !== "" & product_type !== null) {
                        $("#product_type_chosen").css("border", "1px solid #dfe8f1");
                    
                    }
                    if (instock !== "" & instock !== null) {
                        $("#instock").css("border", "1px solid #dfe8f1");
                                        }
                    if (product_unit !== "" & product_unit !== null) {
                        $("#product_unit_chosen").css("border", "1px solid #dfe8f1");
                    
                    }
                    if (purchase_unit !== "" & purchase_unit !== null) {
                        $("#purchase_unit_chosen").css("border", "1px solid #dfe8f1");
                    
                    }
                    if (sale_unit !== "" & sale_unit !== null) {
                        $("#sale_unit_chosen").css("border", "1px solid #dfe8f1");
                    
                    }
                    if (product_category !== "" & product_category !== null) {
                        $("#product_category_chosen").css("border", "1px solid #dfe8f1");
