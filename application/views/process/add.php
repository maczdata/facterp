...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Add Process</h2>
                                <p>Add Required information for Process</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>process/add" id="SubmitAdd" class="form-horizontal bordered-row" onsubmit="return validation_for_raw_metrial();">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-8">New Raw Material</label>
                                                <div class="col-sm-4">
...
//                                                        alert(id);
                                                ...
                                                function validation_for_raw_metrial() {
...
//                    alert(attach_to);
                                                    ...
                                                    $.post(base_url + "process/GetProductsWithSection", {section_id: section_id})
                                                            .done(function (data) {
//                    alert(data);
                                                                // console.log(data);
                                                                $("#" + attach_to).val(data);
...
//                    alert(m_qty);
                ...
                function GetTotalIssue(product_id, product_name_id) {
                    ...
                    var base_url = "<?= base_url() ?>";
                    $.post(base_url + "process/GetTotalIssue", {product_id: product_id})
                            .done(function (data) {
//
