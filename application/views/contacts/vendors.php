...
//        $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" >
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            <h2>Vendors</h2>
                                            <p>Add, Edit a Vendor</p>
                                        </div>

                                   

                                        <div class="col-md-2 col-lg-offset-8">
                                            <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Customer</button>
											...
											<?php if(!empty($contacts)):
												...
												foreach ($contacts as $contact):
													...
													<tr>
														...
														<td>
															<a class="btn btn-outline-primary waves-effect waves-light" href="<?=site_url('contacts/edit_vendor/'.$contact->contact_id);?>"> Edit</a>
														</td>
													</tr>
            ...
            <script>
                                                            ...
                                                            function AddUser() {
                                                                window.location.href = "<?= base_url() ?>contacts/new_vendor";
                                                            }
