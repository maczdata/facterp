...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Add a New Sale Order</h2>
                                <p>Add Required information for Sale Order</p>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>sale_order/add" id="SubmitAdd" class="form-horizontal bordered-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12" style="display:none;">
                                                    ...
                                                    <div id="total" class="col-sm-2" style="font-size: 22px; font-weight: bold; color:#003eff;"><span>0.00</span> Rs
                                                        <input type="hidden" name="ordr_total" id="ordr_total" />
                                                    </div>
                                                </div>
...
//                                                document.getElementsByClassName("discount").addEventListener('keyup', checkTabPress);
                                                ...
                                                function TotalordrAmount() {
                                                    ...
                                                    $("#ordr_total").val(parseFloat(total - total_discount).toFixed(2));
                                                }
                                                ...
                                                function add_product() {
                                                    ...
                                                    var html = '<div class="col-sm-12 prod" id="prod' + id + '"><div class="col-sm-5">';
                                                    ...
                                                    html += '</div><div  class="col-sm-4"><div id="div_qty' + id + '" class="input-group"><input step=".01" type="number" onkeyup="CalculateSubTotal(' + id + ');" name="qty[]" step=".01" id="qty' + id + '" class="form-control" placeholder="Qty"></div></div>';
                                                    html += '<div style="display:none;" class="col-sm-2"><div id="div_sale_price' + id + '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" onkeyup="CalculateSubTotal(' + id + ');" step="0.01" name="sale_price[]" id="sale_price' + id + '" class="form-control" placeholder="Sale Price"></div></div>';
                                                    html += '<div style="display:none;" class="col-sm-2" style="width:13%;"><div id="div_discount' + id + '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" step="0.01" onkeydown="checkTabPress(event);" onkeyup="CalculateSubTotal(' + id + ');"  name="discount[]" id="discount' + id + '" class="form-control discount" placeholder="Discount"></div></div>';
                                                    html += '<div " class="col-sm-2" style="width:12%;"><div id="div_batch' + id + '" class="input-group"><select onchange="GetBatchProCount(this.value,' + id + ')" name="batch[]" id="batch' + id + '" class="chosen-select">' + $("#batch_suggestions").val() + '</select></div></div>';
                                                    html += '<div style="display:none;" class="col-sm-1" style="width:12%;"><div class="input-group"><input type="number" readonly="" onblur="setTwoNumberDecimal(this.id)" step="0.01" name="sub_total[]" id="sub_total' + id + '" value="0.00" class="form-control sub_total" placeholder="Sub Total"></div></div>';
                                                    html += '<div class="col-sm-2" style="width:4%;"><div class="input-group"><button type="button"  onclick="DelProd(' + id + ')" class="btn btn-danger cross" onkeydown="checkTabPress(event);">X</button></div></div> </div>';
//                                                    alert(html);
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group" style="display:none;">
                                                ...
                                                <div class="col-sm-2">
                                                    <input onblur="setTwoNumberDecimal(this.id);" onkeyup="TotalordrAmount();" type="number" name="total_discount" id="total_discount" class="form-control" placeholder="Total discount">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="sv_no" id="sv_no" class="form-control" value="<?= isset($last_sale_no) ? strip_tags($last_sale_no) : '' ?>" Readonly="" >
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="bag" id="bag" class="form-control" placeholder="Enter No of Bags">
                                                </div>


                                                <label class="col-sm-2 control-label">No Of Cartons</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="carton" id="carton" class="form-control" placeholder="Enter No of Cartons">
                                                </div>
                                            </div>
                                            <div class="form-group" style="display:none;">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="cargo" id="cargo" class="form-control" placeholder="Enter Batch No">
                                                </div>

                                                <label class="col-sm-2 control-label">Bilty No</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="builty_no" id="builty_no" class="form-control" placeholder="Enter Batch No">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button id="confrm_btn" class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>CONFIRM ADD NEW SALE</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
...
//                    }
                    ...
                    $(".prod").each(function (i) {
                        ...
                        if (sale_price == null || sale_price == 0) {
                            $("#sale_price" + i).css("border", "1px solid #dfe8f1");
                            err = true;
                        }
                    });
//                     if (err === true) {
...
//                     }
                ...
                function GetBatchProCount(batch_no, id) {

                    $.post("<?= base_url() ?>sale/GetBatchProCount", {batch_no: batch_no}, function (result) {



                        var res = result.split("%");
                        var total_sale_qty = parseFloat(res[0]);
                        var max_qty = parseFloat(res[1]);
                        var curr_qty = parseFloat($("#qty" + id).val());
                        var total_curr_sale_qty = curr_qty + total_sale_qty;
                        alert(result);
//                        return false;
                        if (total_curr_sale_qty > max_qty) {
