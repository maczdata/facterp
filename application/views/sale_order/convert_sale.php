...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Order Convert Into Sale</h2>
                                <p>Add Required information for Sale</p>
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="sv_no" id="sv_no" class="form-control" readonly="" value="<?= $last_sale_no ?>">
                                                </div>


                                                <label class="col-sm-2 control-label">No Of Bags</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="bag" id="bag" class="form-control" placeholder="Enter No of Bags" value="<?= $ordr[0]->bag ?>">
                                                </div>


                                                <label class="col-sm-2 control-label">No Of Cartons</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="carton" id="carton" class="form-control" placeholder="Enter No of Cartons" value="<?= $ordr[0]->carton ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button id="confrm_btn" class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>Confirm Order Convert Into SALE</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
