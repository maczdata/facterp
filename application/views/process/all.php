            ...
            $(document).ready(function () {
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-8">
                                    <h2>process Slips</h2>
                                    <p>Add, Edit or Delete process Slips</p>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <button class="btn btn-blue-alt pull-right" onclick="Addprocess();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add New Process</button>
                                </div>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false">
                                <div class="panel-body">
                                    <div class="row" class="select_date">
                                        <form name="AccountForm" method="post" id="AccountForm" action="<?= base_url() ?>process/" class="form-horizontal">
...
<!--                                                        <td>--><?//= $process->section_name ?><!--</td>-->
                                                        ...
                                                        <td>
                                                         <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            ...
                                                            <button class="btn btn-round btn-info" data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="top" title="Edit" onclick="Editprocess('<?= $process->issue_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="Deleteprocess('<?= $process->issue_id ?>');">
                                                                <i class="glyph-icon icon-trash"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-success" data-toggle="tooltip" data-placement="top" title="View" onclick="ViewProcess('<?= $process->issue_id ?>');">
            ...
            <script>
                                                                function Editprocess(issue_id) {
                                                                    window.location.href = "<?= base_url() ?>process/view/" + issue_id;
                                                                 ...
                                                                 function ViewProcess(issue_id) {
                                                                        window.location.href = "<?= base_url() ?>process/view_slip/" + issue_id;
                                                                    }

                                                                function Deleteprocess(issue_id) {
                                                                    var cnfirm = confirm("Are You Sure?");
                                                                    if (cnfirm) {
                                                                        $.post("<?= base_url() ?>process/delete", {id: issue_id})
                                                                                .done(function (data) {
                                                                                   // alert(data);
                                                                                    if ($.trim(data) == 'done') {
                                                                ...
                                                                function Addprocess() {
                                                                    window.location.href = "<?= base_url() ?>process/add";
                                                                }
