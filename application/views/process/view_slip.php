...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Process Slip </title>
                ...
                <div id="page-content-wrapper">
                    <div id="page-content">
                        ...
                        <div class="container">
                            ...
                            <div id="page-title">
                                <h2>Process Slip</h2>
                                <p>Please check Process Slip</p>

                            </div>

                            <script>
                                function printInvoice() {
                                    window.location.href = "<?= base_url() ?>process/print_slip/<?= $issue[0]->issue_id ?>";
//                                    window.print();
                                        }
                            ...
                            <div class="content-box pad25A">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 float-right text-right">
                                        <h4 class="invoice-title">Process Slip</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">Receiver information:</h2>
                                         <h5><?php $section_data=$this->web->GetOne("section_id","sections",$issue[0]->section_id);
                                         echo $section_data[0]->section_name;
                                          ?></h5> 
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <table class="table mrg20T table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($pro_items as $pro_item) {
                                            ...
                                            <tr>
                                                <td><?= $count ?></td>
                                                <td><?php $products_data=$this->web->GetAllWithInner("product_id","products","units","unit_id" ,NULL,NULL," where product_id={$pro_item->product_id}");
                                                echo $products_data[0]->product_name;
                                                 ?></td>
                                                <td class="text-center"><?= $pro_item->credit_qty . " " . $products_data[0]->unit_symbol ?></td>
                                            </tr>
                                            <?php
                                            $qty = $qty + $pro_item->credit_qty;
                                            $count++;
                                        }
                                        ?>
                                    </tbody>
