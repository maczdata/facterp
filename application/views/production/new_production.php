                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
												<form name="AccountForm" method="get" id="AccountForm" action="<?= base_url() ?>production/add" class="form-horizontal">
													<div class="form-group">
		
													</div>
													
													<div class="form-group">
														<label for="" class="col-sm-6 control-label">Production Warehouse</label>
														<select name="warehouse_id" id="pro_type" class="chosen-select" style=" z-index: -21;" >
													...
													<div class="form-group">
														<label for="" class="col-sm-6 control-label">Target Store</label>
