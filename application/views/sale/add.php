...
//                                                document.getElementsByClassName("discount").addEventListener('keyup', checkTabPress);
                                                ...
                                                function setTwoNumberDecimal(id) {
                                                    ...
                                                    $("#sub_total" + id).val(parseFloat($("#" + id).val()).toFixed(2));
                                                }
                                                ...
                                                function  CalculateSubTotal(id) {
                                                    ...
                                                    var sale_p = $("#sale_price" + id).val();
                                                    sale_p = $("#qty" + id).val() * sale_p;

                                                    var dis = $("#discount" + id).val();
                                                    var sub_t = sale_p - dis;
                                                    $("#sub_total" + id).val(parseFloat(sub_t).toFixed(2));
                                                    TotalInvoiceAmount();
                                                ...
                                                function TotalInvoiceAmount() {
													...
													//$("#sub_total" + id).val(parseFloat(total).toFixed(2));
                                                ...
                                                function add_units(u_id, unit_symbol) {
													...
													var sale_price = $("#sale_price" + id).val();
													 ...
													 sale_price = $("#qty" + id).val() * sale_price;
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-1">
                                                    <input onblur="setTwoNumberDecimal(this.id);" onkeyup="TotalInvoiceAmount();" type="number" name="total_discount" id="total_discount" class="form-control" placeholder="Total discount">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="cargo" id="cargo" class="form-control" placeholder="Enter Cargo Name">
                                                </div>
                                                <label class="col-sm-2 control-label">Bilty No</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="builty_no" id="builty_no" class="form-control" placeholder="Enter Bilty No">
                                                </div>
