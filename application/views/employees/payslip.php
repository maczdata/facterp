...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Payslips</h2>
                                    <p>Add, Edit or Delete Payslips</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddAcount();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Payslip</button>
                                </div>
                            </div>
	...
	<br> <br>
                                                ...
                                                if (!empty($payslips)): $count = 1;
                                                    ...
                                                    foreach ($payslips as $payslip) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $payslip->ledger_amount ?></td>
                                                            <td>
                                                                <?php if ($this->session->userdata('user_group_id') == 1) { ?>

                                                                    <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditAccount('<?= $payslip->employee_ledger_id ?>');">
                                                                        <i class="glyph-icon icon-pencil"></i>
                                                                    </button>
                                                                    <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteAccount('<?= $payslip->employee_ledger_id ?>');">
                                                                        <i class="glyph-icon icon-trash"></i>
                                                                    </button>
                                                                    <button class="btn btn-round btn-success" data-toggle="tooltip" data-placement="top" title="View" onclick="ViewAccount('<?= $payslip->employee_ledger_id ?>');">
            ...
            <script>
                                                                        ...
                                                                        function EditAccount(account_id) {
                                                                            window.location.href = "<?= base_url() ?>employees/view_payslip/" + account_id;
                                                                        }
                                                                        function ViewAccount(account_id) {
                                                                            window.location.href = "<?= base_url() ?>employees/view_payslip_print/" + account_id;
                                                                        }
                                                                        function DeleteAccount(account_id) {
                                                                            var cnfirm = confirm("Are You Sure?");
                                                                            if (cnfirm) {
                                                                                $.post("<?= base_url() ?>employees/delete_payslip", {id: account_id})
                                                                                        .done(function (data) {
                                                                                            if ($.trim(data) == 'done') {
                                                                        ...
                                                                        function AddAcount() {
                                                                            window.location.href = "<?= base_url() ?>employees/add_payslip";
                                                                        }
                ...
                $("#search").keyup(function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        if (rtngPtId == "") {
                            ...
                            $.post("<?= base_url() ?>Advances/search", {id: rtngPtId})
                                    .done(function (data) {
