...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Add Employee </title>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>employees/add" id="SubmitAdd" class="form-horizontal bordered-row" enctype="multipart/form-data">
                                            ...
                                            <div class="tab-pane pad0A fade active in" id="tab-example-4">
                                                <div class="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_father_name"  id="emp_father_name" class="form-control" placeholder="Employee Father Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Date of Birth</label>
                                                        <div class="col-sm-6">
                                                            <input id="emp_dob" name="emp_dob" type="text" class="bootstrap-datepicker form-control" value="<?php echo date("m-d-Y") ?>" data-date-format="mm/dd/yy">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="radio" name="emp_gender" value="other"> Other
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Phone</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_phone" id="emp_phone" class="form-control"  placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Local Address</label>
                                                        <div class="col-sm-6">
                                                            <textarea  rows="3" id="emp_local_address" name="emp_local_address" class="form-control textarea-autosize"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Permanent Address</label>
                                                        <div class="col-sm-6">
                                                            <textarea name="emp_permanent_address" id="emp_permanent_address" rows="3" class="form-control textarea-autosize"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Nationality</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_nationality" id="emp_nationality" class="form-control" id="emp_dob" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Marital Status</label>
                                                        <div class="col-sm-6">
                                                            <input type="radio" name="emp_marital_status" value="single" checked> Single &nbsp; &nbsp;
                                                            <input type="radio" name="emp_marital_status" value="married"> Married &nbsp; &nbsp;
                                                        </div>
                                                    </div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" name="emp_bank" id="emp_bank" class="form-control" placeholder="">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" name="emp_nuban" id="emp_nuban" class="form-control" placeholder="">
														</div>
													</div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div>
                                                                    ...
                                                                    <img class="col-md-6 pull-right" src="" style="width:80px; height: 50px;margin-top: -14px;" id="emp_photoo"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="tab-example-1">
                                                <div class="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_designation"  class="form-control" id="emp_designation" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Date of Joining</label>
                                                        <div class="col-sm-6">
                                                            <input id="emp_doj" name="emp_doj" type="text" class="bootstrap-datepicker form-control" value="<?php echo date("m-d-Y") ?>" data-date-format="mm/dd/yy">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="checkbox" data-on-color="info" data-size="small" name="emp_status" id="emp_status" class="input-switch" data-size="small" data-on-text="On" data-off-text="Off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
