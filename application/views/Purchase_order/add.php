...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                ...
                                <p>Add Required information for Purchase Order</p>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>Purchase_order/add" id="SubmitAdd" class="form-horizontal bordered-row">
...
//                                                document.getElementsByClassName("discount").addEventListener('keyup', checkTabPress);
                                                ...
                                                function add_product() {
                                                    ...
                                                    html += '</div><div  class="col-sm-5"><div id="div_qty' + id + '" class="input-group"><input step=".01" type="number" name="qty[]" step=".01" id="qty' + id + '" class="form-control" placeholder="Qty"></div></div>';
                                                    html += '<div style="display:none;" class="col-sm-2"><div id="div_Purchase_price' + id + '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" onkeyup="CalculateSubTotal(' + id + ');" step="0.01" name="Purchase_price[]" id="Purchase_price' + id + '" class="form-control" placeholder="Purchase Price"></div></div>';
                                                    ...
                                                    html += '<div " class="col-sm-2" style="width:12%; display:none;"><div id="div_batch' + id + '" class="input-group"><select onchange="GetBatchProCount(this.value,' + id + ')" name="batch[]" id="batch' + id + '" class="chosen-select">' + $("#batch_suggestions").val() + '</select></div></div>';
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="sv_no" id="sv_no" class="form-control" value="<?= isset($last_Purchase_no) ? strip_tags($last_Purchase_no) : '' ?>" Readonly="" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button id="confrm_btn" class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>CONFIRM ADD NEW Purchase Order</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
