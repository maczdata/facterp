...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Edit Employee </title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <h2>Add Information for Employee</h2>
                                <p>Fill Required Information Correctly</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>employees/edit/<?= $employee[0]->employee_id ?>" id="SubmitAdd" class="form-horizontal bordered-row" enctype="multipart/form-data">
                                            <input type="hidden" name="employee_last_id" value="<?= $employee[0]->emp_unique_id ?>"/>
                                            ...
                                            <div class="tab-pane pad0A fade active in" id="tab-example-4">
                                                <div class="">
                                                    ...
                                                    <div class="form-group remove-border">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_name"  id="emp_name" class="form-control"  placeholder="Employee Name" value="<?= $employee[0]->emp_name ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Father / Husband Name</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_father_name"  id="emp_father_name" class="form-control" placeholder="Employee Father Name" value="<?= $employee[0]->emp_father_name ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Date of Birth</label>
                                                        <div class="col-sm-6">
                                                            <input id="emp_dob" name="emp_dob" type="text" class="bootstrap-datepicker form-control" value="<?php echo date("m-d-Y", strtotime($employee[0]->emp_dob)) ?>" data-date-format="mm/dd/yy">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Gender</label>
                                                        <div class="col-sm-6">
                                                            <input type="radio" name="emp_gender" value="male" <?= $employee[0]->emp_gender == 'male' ? "checked" : "" ?>> Male &nbsp; &nbsp;
                                                            <input type="radio" name="emp_gender" value="female" <?= $employee[0]->emp_gender == 'female' ? "checked" : "" ?>> Female &nbsp; &nbsp;
                                                            <input type="radio" name="emp_gender" value="other" <?= $employee[0]->emp_gender == 'other' ? "checked" : "" ?>> Other
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Phone</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_phone" id="emp_phone" class="form-control"  placeholder="" value="<?= $employee[0]->emp_phone ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Local Address</label>
                                                        <div class="col-sm-6">
                                                            <textarea  rows="3" id="emp_local_address" name="emp_local_address" class="form-control textarea-autosize"><?= $employee[0]->emp_local_address ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Permanent Address</label>
                                                        <div class="col-sm-6">
                                                            <textarea name="emp_permanent_address" id="emp_permanent_address" rows="3" class="form-control textarea-autosize"><?= $employee[0]->emp_permanent_address ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Nationality</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_nationality" id="emp_nationality" class="form-control" id="emp_dob" placeholder="" value="<?= $employee[0]->emp_nationality ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Marital Status</label>
                                                        <div class="col-sm-6">
                                                            <input type="radio" name="emp_marital_status" value="single" <?= $employee[0]->emp_marital_status == 'single' ? "checked" : "" ?>> Single &nbsp; &nbsp;
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div>
                                                                    <span class="btn btn-default btn-file">
                                                                        ...
                                                                        <input type="file" id="emp_photo" name="emp_photo" onchange="ohcomeon(this, this.id);">
                                                                    </span>
                                                                    <img class="col-md-6 pull-right" src="<?= !empty($employee[0]->emp_photo) ? "../../images/{$employee[0]->emp_unique_id}/{$employee[0]->emp_photo}" : "" ?>" style="width:80px; height: 50px;margin-top: -14px;" id="emp_photoo"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="tab-example-1">
                                                <div class="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_designation"  class="form-control" id="emp_designation" placeholder="" value="<?= $employee[0]->emp_designation ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Date of Joining</label>
                                                        <div class="col-sm-6">
                                                            <input id="emp_doj" name="emp_doj" type="text" class="bootstrap-datepicker form-control" value="<?php echo date("m-d-Y", strtotime($employee[0]->emp_doj)) ?>" data-date-format="mm/dd/yy">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Joining Salary</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="salary" id="salary" class="form-control"  placeholder="" value="<?= $employee[0]->salary ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Employee Documents</label>
                                                        <span class="btn btn-md btn-success fileinput-button col-sm-6">
                                                            <i class="glyph-icon icon-plus"></i>
                                                            Add files...
                                                            <input type="file" name="emp_documents[]" multiple="">
                                                        </span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Is it active?</label>
                                                        <div class="col-sm-6">
                                                            <input type="checkbox" data-on-color="info" data-size="small" name="emp_status" id="emp_status" class="input-switch" data-size="small" data-on-text="On" data-off-text="Off" <?= $employee[0]->emp_status == 1 ? "checked" : "" ?>>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-6">Description</label>
                                                        <div class="col-sm-12">
                                                            <textarea name="emp_desc" id="emp_desc"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                            <span>CONFIRM ADD NEW Employee</span>
                                                            <i class="glyph-icon icon-arrow-right"></i>
                                                        </button>
                                                        <div class="col-md-4 col-sm-0"></div>
                                                    </div>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            $("#emp_dob").bsdatepicker({
                                format: 'mm-dd-yyyy'
                            });

                            $('#emp_dob').on('changeDate', function (ev) {
                                $(this).bsdatepicker('hide');
                            });
                            $("#emp_doj").bsdatepicker({
                                format: 'mm-dd-yyyy'
                            });

                            $('#emp_doj').on('changeDate', function (ev) {
                                $(this).bsdatepicker('hide');
                            });
                    ...
                    <script>
                        function ConfirmAdd() {
                            ...
                            var emp_father_name = $("#emp_father_name").val();
                            var emp_local_address = $("#emp_local_address").val();
                            ...
                            if (emp_father_name == "" || emp_father_name == null) {
                                $("#emp_father_name").css("border", "1px solid red");
                                err = true;
                            }
                            if (emp_local_address == "" || emp_local_address == null) {
                                $("#emp_local_address").css("border", "1px solid red");
                                err = true;
                            }
                            if (err === true) {
                                return false;
                        ...
                        function ohcomeon(input, id = null) {
//    alert(id);
//    alert(input);
