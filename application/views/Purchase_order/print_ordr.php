    ...
    <body onload="print_me();">
        <table width="100%" >
            <tr>
                ...
                <td colspan="6" class="text-right mrg10L" valign="top" style="height:50px">
                    <h4 class="invoice-title">Purchase Order</h4>
                    No. <b>#<?= $ordr[0]->ordr_id ?></b>
                    <div class="invoice-date mrg20B"><?= date("j F Y", strtotime($ordr[0]->date_created)) ?></div>
                </td>
            </tr>
        </table>
        ...
        <hr>
        <table width="100%">
            <tr style="font-weight: bold;"><th  colspan="4"><h3 class="">Client information:</h3></th>
                <th colspan="4"><h3 class="">Order Info:</h3></th>
                <th colspan="4"><h3 class="">Order Details:</h3></th>
            </tr>
            <tr>
                <td colspan="4">
                ...
                foreach ($ordr_items as $inv_item) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $inv_item->qty . " " . $inv_item->unit ?></td>
                                                <!-- <td class="text-center"><?= $inv_item->product_Purchase_price ?> Rs</td> -->
                        <td class="text-center"><?= $inv_item->batch ?></td>
                                        <!-- 	<td><?= $inv_item->discount ?> Rs</td>
                        <td><?= $inv_item->ordr_subtotal ?> Rs</td> -->
                    </tr>
                    <?php
                    $counter++;
                }
