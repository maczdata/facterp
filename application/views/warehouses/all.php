...
<html  lang="en">
    ...
    <head>
        ...
        <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
            <title> Facteezo: Warehouses </title>
    ...
    $(document).ready(function () {
        $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Warehouses</h2>
                                    <p>Add, Edit or Delete Warehouses</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Warehouse</button>
                                </div>
                            </div>
...
<tr>
    ...
    <th>Manage</th>
                                                ...
                                                <?php foreach ($warehouses as $warehouse) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditWarehouse('<?= $warehouse->warehouse_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteWarehouse('<?= $warehouse->warehouse_id ?>');">
                                                                <i class="glyph-icon icon-trash"></i>
                                                            </button>
                                                        <?php } ?>    
                                                            <button onclick="GoLedger('<?= $warehouse->warehouse_id ?>');"  class="btn btn-round btn-success" >
            ...
            <script>
                                                            function EditWarehouse(unit_id) {
                                                                window.location.href = "<?= base_url() ?>warehouses/view/" + unit_id;
                                                            ...
                                                            function DeleteWarehouse(unit_id) {
                                                                var cnfirm = confirm("Are You Sure?");
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>warehouses/delete", {id: unit_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddUser() {
                                                                window.location.href = "<?= base_url() ?>warehouses/add";
                                                            }
