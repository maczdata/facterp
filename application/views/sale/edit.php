...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Edit Sale</h2>
                                <p>Edit Required information for Sale</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>sale/edit" id="SubmitAdd" class="form-horizontal bordered-row">
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="sv_no" id="sv_no" class="form-control" readonly="" value="<?= $invoice[0]->voucher_no ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="destination" id="destination" class="form-control" placeholder="Enter Destination" value="<?= $invoice[0]->destination ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Driver Name</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="driver_name" id="driver_name" class="form-control" placeholder="Enter Driver Name" value="<?= $invoice[0]->driver_name ?>">
                                                </div>
                                                <label class="col-sm-2 control-label">Mobile No.</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Enter Mobile No." value="<?= $invoice[0]->mobile_no ?>">
                                                </div>
                                            </div>
