						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-2">
									...
									<p>View Stock in your warehouse and Store</p>
								</div>
						...
						<div class="panel-body">
							...
							<div class="example-box-wrapper">
								<table  class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
									...
									<?php
										if (!empty($new_products_stores)): $count = 1;
											foreach ($new_products_stores as $product):
												?>
												<tr>
													<td><?= $count ?></td>
													<td> <?=$product->store_name; ?></td>
													<td><?= $product->store_stock_quantity ?></td>
						...
						<div class="panel-body">
							...
							<div class="example-box-wrapper">
								<table  class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
									...
									<?php
										if (!empty($new_products_warehouses)): $count = 1;
											foreach ($new_products_warehouses as $product):
												?>
												<tr>
													<td><?= $count ?></td>
