...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                <h2>Edit store</h2>
                                <p>Update Name or Symbol for store</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>stores/edit" id="SubmitEdit" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">store Name</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-circle-o"></span>
                                                        <input type="text" name="name" id="name" value="<?= $store[0]->store_name ?>" class="form-control" placeholder="Section Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="address" id="address" value="<?= $store[0]->store_address ?>" class="form-control" placeholder="Address">
                                                    </div>
                                                </div>
                                            </div>
